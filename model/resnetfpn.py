...
class ResnetFPN(FPN):
  def __init__(self, arch='resnet50', pretrained=False, model_path=None):
  ...
  def _init_modules(self):
    if self.arch == 'resnet50':
        ...
        print(f'Architecture {self.arch} doesn\'t exist. Falling back to resnet18.')
        resnet = resnet18(self.pretrained)

    if self.pretrained == False and self.model_path:
