...
from data.textdataset import SynthTextDataset
...
class OCRDataLoaderFactory(BaseDataLoader):
    ...
    def train(self):
        trainLoader = torchdata.DataLoader(self.__trainDataset, num_workers = self.num_workers, batch_size = self.batch_size, shuffle = self.shuffle, collate_fn = collate_fn)
        return trainLoader
